...
if(state == 2)
{
	...
	draw_text_transformed(room_width / 2, 64 /*room_height / 6*/, "COMPLETE!", 4, 4, 0);
	draw_text_transformed(room_width / 2, 128
	/*room_height / 6*/, "Click the left mouse button to continue.", 2, 2, 0);
